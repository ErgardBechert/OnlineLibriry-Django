...
SECRET_KEY = 'django-insecure-9^lfyrn7l(wg(&&txu9e9!zz(+u+b=!)(ok07o1appt1u8gj07'
...
LOGIN_REDIRECT_URL = '/' #после авторизации переопределяет на галвнцю страницу,а не в профиль как по умолчанию
